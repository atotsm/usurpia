// Usurpia Lens Bookmarklet - V2.5.5 (Hardened & Optimized)
// Fixes critical memory leaks, restores mobile/touch functionality, and optimizes performance.
...
(function() {
    ...
    const config = {
        ...
        dictionary: { // Dictionary content omitted for brevity, assumed to be the same
    ...
    function main() {
        ...
        console.log("Usurpia Lens v2.5.5 Activated.");
        loadSettings();
        injectStyles();
    ...
    function createControlPanel() {
        ...
        panel.innerHTML = `
            <div id="usurpia-panel-header">Usurpia Lens v2.5.5</div>
    ...
    function highlightKeywords(maxHighlights) {
        ...
        if (candidates.length > maxHighlights) {
            ...
            for (let i = 0; i < maxHighlights; i++) {
                ...
                highlightsToPerform.push(candidates[randomIndex]);
                candidates[randomIndex] = candidates[len - 1];
                len--;
            }
        }
